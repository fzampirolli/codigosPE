...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2794}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2281}}
...
strcat(s1,s2) & copia s2 no final de s1 \\
strlen(s) & tamanho de s \\
strcmp(s1,s2) & 0 se s1=s2; negativo se s1\textless s2; positivo se
s1\textgreater s2 \\
strchr(s,ch) & ponteiro para a primeira ocorrência de ch em s \\
strstr(s1,s2) & ponteiro para a primeira ocorrência de s2 em s1 \\
\bottomrule()
\end{longtable}
...
elementos, contendo valores de 1 a 5, e considerando também que \(x=1\).
    ...
    \begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0182}}
...
\end{itemize}
    ...
    \begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0167}}
...
eficiente entre eles não poderá ser melhor que \(\Omega(n*log \ n)\).
    ...
    \begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0159}}
...
\midrule()
\endhead
1 & para i=0; i \textless{} n-1; i++ & n-1 \\
