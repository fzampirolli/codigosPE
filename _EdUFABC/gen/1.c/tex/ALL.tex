...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}}\PY{o}{\PYZpc{}}\PY{n}{shell}
\PY{n}{gcc} \PY{o}{\PYZhy{}}\PY{n}{Wall} \PY{o}{\PYZhy{}}\PY{n}{std}\PY{o}{=}\PY{n}{c99} \PY{n}{cap4ex01}\PY{o}{.}\PY{n}{c} \PY{o}{\PYZhy{}}\PY{n}{o} \PY{n}{output2}
\PY{o}{.}\PY{o}{/}\PY{n}{output2}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}}\PY{o}{\PYZpc{}}\PY{n}{shell}
\PY{n}{gcc} \PY{o}{\PYZhy{}}\PY{n}{Wall} \PY{o}{\PYZhy{}}\PY{n}{std}\PY{o}{=}\PY{n}{c99} \PY{n}{cap4ex02}\PY{o}{.}\PY{n}{c} \PY{o}{\PYZhy{}}\PY{n}{o} \PY{n}{output2}
\PY{o}{.}\PY{o}{/}\PY{n}{output2}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}}\PY{o}{\PYZpc{}}\PY{n}{writefile} \PY{n}{cap6ex02}\PY{o}{.}\PY{n}{c}
\PY{c+c1}{\PYZsh{}include \PYZlt{}stdio.h\PYZgt{}}

\PY{n+nb}{int} \PY{n}{main}\PY{p}{(}\PY{p}{)} \PY{p}{\PYZob{}}
  \PY{n}{char}\PY{o}{*} \PY{n}{filename} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{teste.txt}\PY{l+s+s2}{\PYZdq{}}\PY{p}{;}

  \PY{n}{FILE}\PY{o}{*} \PY{n}{fp} \PY{o}{=} \PY{n}{fopen}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{w}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{;} \PY{o}{/}\PY{o}{/} \PY{n}{Cria} \PY{n}{arquivo} \PY{n}{para} \PY{n}{escrita}
  \PY{k}{if} \PY{p}{(}\PY{n}{fp} \PY{o}{==} \PY{n}{NULL}\PY{p}{)} \PY{p}{\PYZob{}}
  ...
  \PY{k}{for} \PY{p}{(}\PY{n+nb}{int} \PY{n}{i} \PY{o}{=} \PY{l+m+mi}{0}\PY{p}{;} \PY{n}{i} \PY{o}{\PYZlt{}} \PY{l+m+mi}{10}\PY{p}{;} \PY{n}{i}\PY{o}{+}\PY{o}{+}\PY{p}{)}
    \PY{n}{fprintf}\PY{p}{(}\PY{n}{fp}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Linha }\PY{l+s+si}{\PYZpc{}02d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{i} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{;} \PY{o}{/}\PY{o}{/} \PY{n}{Escrever} \PY{n}{algo} \PY{n}{no} \PY{n}{arquivo}

  \PY{n}{fclose}\PY{p}{(}\PY{n}{fp}\PY{p}{)}\PY{p}{;} \PY{o}{/}\PY{o}{/} \PY{n}{fecha} \PY{n}{arquivo}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}}\PY{o}{\PYZpc{}}\PY{n}{shell}
\PY{n}{gcc} \PY{o}{\PYZhy{}}\PY{n}{Wall} \PY{o}{\PYZhy{}}\PY{n}{std}\PY{o}{=}\PY{n}{c99} \PY{n}{cap6ex02}\PY{o}{.}\PY{n}{c} \PY{o}{\PYZhy{}}\PY{n}{o} \PY{n}{output2}
\PY{o}{.}\PY{o}{/}\PY{n}{output2}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}}\PY{o}{\PYZpc{}}\PY{n}{writefile} \PY{n}{cap6ex03}\PY{o}{.}\PY{n}{c}
\PY{c+c1}{\PYZsh{}include \PYZlt{}stdio.h\PYZgt{}}

\PY{n+nb}{int} \PY{n}{main}\PY{p}{(}\PY{p}{)} \PY{p}{\PYZob{}}
  \PY{n}{char}\PY{o}{*} \PY{n}{filename} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{teste.txt}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{ch}\PY{p}{;}

  \PY{n}{FILE}\PY{o}{*} \PY{n}{fp}\PY{p}{;}
  \PY{n}{fp} \PY{o}{=} \PY{n}{fopen}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{r}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{;} \PY{o}{/}\PY{o}{/} \PY{n}{Cria} \PY{n}{arquivo} \PY{n}{para} \PY{n}{escrita}
  \PY{k}{if} \PY{p}{(}\PY{n}{fp} \PY{o}{==} \PY{n}{NULL}\PY{p}{)} \PY{p}{\PYZob{}}
    \PY{n}{printf}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Erro ao abrir o arquivo: }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{filename}\PY{p}{)}\PY{p}{;}
    \PY{k}{return} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{;}
  \PY{p}{\PYZcb{}}

  \PY{k}{while} \PY{p}{(}\PY{p}{(}\PY{n}{ch} \PY{o}{=} \PY{n}{fgetc}\PY{p}{(}\PY{n}{fp}\PY{p}{)}\PY{p}{)} \PY{o}{!=} \PY{n}{EOF}\PY{p}{)} \PY{p}{\PYZob{}} \PY{o}{/}\PY{o}{/} \PY{n}{Lê} \PY{n}{arquivo}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}}\PY{o}{\PYZpc{}}\PY{n}{shell}
\PY{n}{gcc} \PY{o}{\PYZhy{}}\PY{n}{Wall} \PY{o}{\PYZhy{}}\PY{n}{std}\PY{o}{=}\PY{n}{c99} \PY{n}{cap6ex03}\PY{o}{.}\PY{n}{c} \PY{o}{\PYZhy{}}\PY{n}{o} \PY{n}{output3}
\PY{o}{.}\PY{o}{/}\PY{n}{output3}
\end{Verbatim}
\end{tcolorbox}
