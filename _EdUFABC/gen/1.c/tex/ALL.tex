...
\item
  ...
  \item
    ...
    (ou exclusivo `XOR' bit-a-bit) ◦ \textless{}\textless{} N
    (shift-left, adiciona N zeros à direita do número em binário) ◦
...
\end{itemize}
    ...
    \begin{longtable}[]{@{}lll@{}}
\toprule
& Função ordena(int vet, int n) & Número de instruções\tabularnewline
\midrule
\endhead
1 & para i=0; i\textless{}n; i++ & n\tabularnewline
2 & \_ para j=0; j\textless{}n; j++ & n*n\tabularnewline
3 & \_ \_ se v{[}i{]} \textgreater{} v{[}j{]} & n*n\tabularnewline
4 & \_ \_ \_ int aux = v{[}i{]} & \textless{} n*n\tabularnewline
5 & \_ \_ \_ v{[}i{]} = v{[}j{]} & \textless{} n*n\tabularnewline
6 & \_ \_ \_ v{[}j{]} = aux & \textless{} n*n\tabularnewline
...
eficiente entre eles não poderá ser melhor que \(\Omega(n*log \ n)\).
    ...
    \begin{longtable}[]{@{}lll@{}}
\toprule
& Função ordena2(int vet, int n) & Número de instruções\tabularnewline
\midrule
\endhead
1 & para i=0; i \textless{} n-1; i++ & n-1\tabularnewline
2 & \_ para j=i+1; j \textless{} n; j++ &
n+n-1+n-2+\ldots{}+1\tabularnewline
3 & \_ \_ se v{[}i{]} \textgreater{} v{[}j{]} &
n+n-1+n-2+\ldots{}+1\tabularnewline
4 & \_ \_ \_ int aux = v{[}i{]} & \textless{}
n+n-1+n-2+\ldots{}+1\tabularnewline
5 & \_ \_ \_ v{[}i{]} = v{[}j{]} & \textless{}
n+n-1+n-2+\ldots{}+1\tabularnewline
6 & \_ \_ \_ v{[}j{]} = aux & \textless{}
n+n-1+n-2+\ldots{}+1\tabularnewline
7 & retorne v & 1\tabularnewline
& ** Complexidade ** & \(f(n) = n*n/2 = O(n^2)\)\tabularnewline
\bottomrule
\end{longtable}
