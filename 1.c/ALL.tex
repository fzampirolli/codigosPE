...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}writefile} cap02exem01.c
\PY{c+c1}{\PYZsh{}include \PYZlt{}stdio.h\PYZgt{}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{shell}
gcc cap02exem01.c \PYZhy{}o output2
./output2
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}writefile} cap02exem02.c
\PY{c+c1}{\PYZsh{}include \PYZlt{}stdio.h\PYZgt{}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{shell}
gcc cap02exem02.c \PYZhy{}o output2
./output2
\end{Verbatim}
\end{tcolorbox}
...
\subsection{Exercícios}\label{exercuxedcios}}
    ...
    Ver notebook Colab no arquivo \texttt{cap02.part2.lab.*.ipynb}
(\texttt{*} é a extensão da linguagem), utilizando alguma linguagem de
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}writefile} cap03exem03.c
\PY{c+c1}{\PYZsh{}include \PYZlt{}stdio.h\PYZgt{}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{shell}
gcc cap03exem03.c \PYZhy{}o output3
./output3
\end{Verbatim}
\end{tcolorbox}
...
Condicionais)}\label{revisuxe3o-do-capuxedtulo-anterior-desvios-condicionais}}
    ...
    \begin{itemize}
\item
  No capítulo anterior foram apresentadas formas de construir códico
...
\item
  ...
  tenhamos que repetir 100, 500, 1000 vezes a mesma operação.
\end{itemize}
...
pargunta \texttt{Deseja\ continuar?\ (s/n)}, mas entrando num laço
...
\tightlist
\item
  O que vai ocorrer ao escrever e rodar esse código algum alguma
  linguagem de programação?
\item
  Onde está o erro?
\item
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}writefile} cap04exem01.c
\PY{c+c1}{\PYZsh{}include \PYZlt{}stdio.h\PYZgt{}}
...
\PY{n+nb}{int} \PY{n}{main}\PY{p}{(}\PY{n}{void}\PY{p}{)} \PY{p}{\PYZob{}}
  ...
  \PY{o}{/}\PY{o}{/} \PY{n}{SAÍDA}
  \PY{n}{printf}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{A média das }\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s2}{ notas é }\PY{l+s+si}{\PYZpc{}.1f}\PY{l+s+s2}{ }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{contador}\PY{p}{,} \PY{n}{media}\PY{p}{)}\PY{p}{;}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{shell}
gcc cap04exem01.c \PYZhy{}o output2
./output2
\end{Verbatim}
\end{tcolorbox}
...
\subsection{Exercícios}\label{exercuxedcios}}
    ...
    Ver notebook Colab no arquivo \texttt{cap04.part2.lab.*.ipynb}
(\texttt{*} é a extensão da linguagem), utilizando alguma linguagem de
programação de sua preferência, onganizadas em subpastas contidas de
\texttt{"gen"}, na pasta do Google Drive
\href{https://drive.google.com/drive/folders/1YlFwv8XYN7PYYf-HwDMlkxzbmXzJw9cM?usp=sharing}{colabs}.
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}writefile} cap06exem01.c
\PY{c+c1}{\PYZsh{}include \PYZlt{}stdio.h\PYZgt{}}
\PY{c+c1}{\PYZsh{}include\PYZlt{}malloc.h\PYZgt{}  }
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{shell}
gcc cap06exem01.c \PYZhy{}o output2
./output2
\end{Verbatim}
\end{tcolorbox}
...
\subsection{Exercícios}\label{exercuxedcios}}
    ...
    Ver notebook Colab nos arquivos \texttt{cap06.partX.lab.*.ipynb}
...
EP5\_1 - Média dos alunos
    ...
    \hypertarget{ler-uma-matriz-considerando-cada-linha-da-matriz-um-input}{%
\paragraph{\texorpdfstring{Ler uma matriz considerando cada LINHA da
matriz um
\texttt{input()}:}{Ler uma matriz considerando cada LINHA da matriz um input():}}\label{ler-uma-matriz-considerando-cada-linha-da-matriz-um-input}}
...
\end{tcolorbox}
    ...
    \hypertarget{ler-uma-matriz-considerando-cada-elemento-da-matriz-um-input}{%
\paragraph{\texorpdfstring{Ler uma matriz considerando cada ELEMENTO da
matriz um
\texttt{input()}:}{Ler uma matriz considerando cada ELEMENTO da matriz um input():}}\label{ler-uma-matriz-considerando-cada-elemento-da-matriz-um-input}}
